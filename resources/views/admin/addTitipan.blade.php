...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tambah Titipan</h1>
            </div>
        </div>
        <!-- /.row -->
    </div>
                        ...
                        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-12">
                                    <label class="font-weight-bold">Gambar Produk Titipan</label>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-12">
                                    <label class="font-weight-bold">Nama Produk Titipan</label>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-12">
                                    <label class="font-weight-bold">Harga Produk Titipan</label>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-12">
                                    <label class="font-weight-bold">Satuan Produk Titipan</label>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-12">
                                    <label class="font-weight-bold">Stok Produk Titipan</label>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control @error('id') is-invalid @enderror" name="id_penitip" required>
