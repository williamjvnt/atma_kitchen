        ...
        <div class="border-end fixed-sidebar" style="background-color: #813C3F" id="sidebar-wrapper">
            <div class="d-flex sidebar-heading border-bottom gap-3 p-4" style="background-color: #4B270F;">
                ...
                <div class="text-white fw-bold d-flex flex-column justify-content-center align-items-start">
                    <p class="mb-0" style="font-size: 16px">Owner</p>
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item p-3 custom-bg-color fw-semibold" href="#"><i class="fas fa-right-from-bracket"></i>
                    <span style="margin-left: 9px">Manager Gaji</span></a>
                ...
                <a class="list-group-item p-3 custom-bg-color fw-semibold" href="{{route('laporanProduk',['active_karyawan_id' => session('active_karyawan_id')])}}"><i class="fas fa-right-from-bracket"></i>
